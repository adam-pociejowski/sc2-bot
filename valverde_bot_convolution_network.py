...
# about 165 iterations per minute
class ValverdeBotConvolutionNetwork(sc2.BotAI):
    def __init__(self):
        super().__init__()
...
run_game(maps.get("AbyssalReefLE"), [
    Bot(Race.Protoss, ValverdeBotConvolutionNetwork()),
    Computer(Race.Terran, Difficulty.Hard)
    ], realtime=False)

    # Player(player_id=2, type=PlayerType.Participant, requested_race=Race.Protoss)